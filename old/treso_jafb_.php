...
$crud->setRelation('IDPROJ', 'gl_projet', 'NOMPROJ');
...
$crud->unsetColumns(['IDPROJ','TYPEOPE','journal','Dette_bancaire']);
$crud->unsetAddFields(['IDPROJ','TYPEOPE','journal','Dette_bancaire']);
$crud->unsetEditFields(['IDPROJ','TYPEOPE','journal','Dette_bancaire']);
...
$crud->callbackBeforeInsert(function ($stateParameters) {
    ...
    $stateParameters->data['journal'] = "J AFB";
