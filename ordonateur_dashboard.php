...
<?php
    ...
    if (isset($_SESSION['idu'])&& ( $_SESSION['droit']== "admin" || $_SESSION['droit']== "Ordonateur"  || $_SESSION['droit']== "DPI")){ // si paramètres correct.
?>
...
<html lang="fr">
    ...
    <head>
        ...
        <!-- ======= Title ======= -->
        <title>Dashboard - Courrier | SIGAMP-94</title>
        ...
        <link href="new_assets/assets_dashboard/css/header/style.css" rel="stylesheet" media="all">
         ...
         <!-- ======= Template Main CSS File Dashboard ======= -->
                <?php if ($_SESSION['droit'] != "admin" && $_SESSION['droit']!= "Ordonateur" && $_SESSION['droit']!= "courrier" && $_SESSION['droit']!= "UGAO" && $_SESSION['droit']!= "UGAC" && $_SESSION['droit']!= "UGAD"  && $_SESSION['droit'] != "DPI") {
...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
        ...
        <main id="main" class="main">
            ...
            <div class="card recent-sales">
                <h1 class="card-title text-center fw-bold"> DASHBOARD PROJET: <?php echo($month . ' ' .$annee);?></h1>
            ...
            <div class="modal fade" id="basicModal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="ordonateur_dashboard.php" method="GET">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Statistique de Demande de financement</span></h5>
                                <div id="pieChart1"></div>
                                <script>
                                    document.addEventListener("DOMContentLoaded", () => {
                                        new ApexCharts(document.querySelector("#pieChart1"), {
                                            series: [
                                                <?php echo $nbrfinancement; ?>,
                                                <?php echo $nbrfinancementAccorde; ?>,
                                            ],
                                            chart: {
                                                height: 350,
                                                type: 'pie',
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Projet <span>| En Attente de Validation</span></h5>
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        <?php
                                        $increment = 0;
                                        while ($row = $listingEncours->fetch(PDO::FETCH_ASSOC)) :
