...
<?php
    ...
    $sql = "SELECT COUNT(id_personnel) as NBRES FROM rh_personnel  WHERE (YEAR(date_creation) = $annee && is_delete = 1)";
    $nbr1 = $pdo->query($sql);
    $nbrPersonneltotal = $nbr1->fetchColumn();


    $sql = "SELECT COUNT(id_personnel) as NBRES FROM rh_personnel  WHERE (YEAR(date_creation) = $annee && is_delete = 1 && active = 1)";
    $nbr2 = $pdo->query($sql);
    $nbrPersonnelactif = $nbr2->fetchColumn();

    $sql = "SELECT COUNT(id_soumissionaire) as NBRES FROM soumissionaire  WHERE (YEAR(date_creation) = $annee && is_delete = 1)";
    $nbr3 = $pdo->query($sql);
    $nbrSoumissionaire = $nbr3->fetchColumn();

    $sql = "SELECT COUNT(IDProjet) as NBRES FROM Projet  WHERE (YEAR(date_creation) = $annee && Libelle_avis = 'Favorable' && is_delete = 1)";
    $nbr4 = $pdo->query($sql);
    $mbrProjet = $nbr4->fetchColumn();


    $sql = "SELECT COUNT(id_personnel) as NBRES FROM rh_personnel  WHERE (YEAR(date_creation) = $annee && (DROIT = 'admin' OR DROIT = 'admin#courrier#Ordonateur#CSM#UGAO#UGAC#UGAD')  && is_delete = 1)";
    $nbr5 = $pdo->query($sql);
    $Admin = $nbr5->fetchColumn();
    $sql = "SELECT COUNT(id_personnel) as NBRES FROM rh_personnel  WHERE (YEAR(date_creation) = $annee && DROIT = 'courrier' && is_delete = 1)";
    $nbr6 = $pdo->query($sql);
    $Courriers = $nbr6->fetchColumn();
    $sql = "SELECT COUNT(id_personnel) as NBRES FROM rh_personnel  WHERE (YEAR(date_creation) = $annee && DROIT = 'Ordonateur' && is_delete = 1)";
    $nbr7 = $pdo->query($sql);
    $Ordonateur = $nbr7->fetchColumn();
    $sql = "SELECT COUNT(id_personnel) as NBRES FROM rh_personnel  WHERE (YEAR(date_creation) = $annee && DROIT = 'UGAO' && is_delete = 1)";
    $nbr8 = $pdo->query($sql);
    $UGAO = $nbr8->fetchColumn();
    $sql = "SELECT COUNT(id_personnel) as NBRES FROM rh_personnel  WHERE (YEAR(date_creation) = $annee && DROIT = 'UGAC' && is_delete = 1)";
    $nbr11 = $pdo->query($sql);
    $UGAC = $nbr11->fetchColumn();
    $sql = "SELECT COUNT(id_personnel) as NBRES FROM rh_personnel  WHERE (YEAR(date_creation) = $annee && DROIT = 'UGAD' && is_delete = 1)";
    $nbr9 = $pdo->query($sql);
    $UGAD = $nbr9->fetchColumn();
    $sql = "SELECT COUNT(id_personnel) as NBRES FROM rh_personnel  WHERE (YEAR(date_creation) = $annee && DROIT = 'CSM' && is_delete = 1)";
    $nbr10 = $pdo->query($sql);
    $CSM = $nbr10->fetchColumn();


    $sql = "SELECT * FROM logs  ORDER BY id_logs DESC LIMIT 10";
...
<html lang="fr">
    ...
    <head>
        ...
        <!-- ======= Title ======= -->
        <title>Dashboard - ADMIN| SIGAMP-94</title>
...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
        ...
        <main id="main" class="main">
            ...
            <div class="card recent-sales">
                <h1 class="card-title text-center fw-bold"> DASHBOARD ADMIN : <?php echo($month . ' ' .$annee);?></h1>
                ...
                <div class="row">
                     ...
                     <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card info-card sales-card">
                            <div class="card-body">
                                <h5 class="card-title">Utilisateur <span>| Total</span></h5>
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <h6><?php echo $nbrPersonneltotal; ?></h6>
                                        <span class="text-success small pt-1 fw-bold"><?php echo $nbrPersonneltotal ?></span> <span class="text-muted small pt-2 ps-1">Utilisateur</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card info-card sales-card">
                            <div class="card-body">
                                <h5 class="card-title">Utilisateur <span>| Actif</span></h5>
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <h6><?php echo $nbrPersonnelactif; ?></h6>
                                        <span class="text-success small pt-1 fw-bold"><?php echo $nbrPersonnelactif ?></span> <span class="text-muted small pt-2 ps-1">Utilisateur</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card info-card sales-card">
                            <div class="card-body">
                                <h5 class="card-title">Soumissionaires</h5>
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <h6><?php echo $nbrSoumissionaire; ?></h6>
                                        <span class="text-success small pt-1 fw-bold"><?php echo $nbrSoumissionaire ?></span> <span class="text-muted small pt-2 ps-1">Soumissionaire</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card info-card sales-card">
                            <div class="card-body">
                                <h5 class="card-title">Projet <span>| Validés</span></h5>
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <h6><?php echo $mbrProjet; ?></h6>
                                        <span class="text-success small pt-1 fw-bold"><?php echo $mbrProjet ?></span> <span class="text-muted small pt-2 ps-1">Projet</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Vue d'ensemble des Utilisarteurs</span></h5>
                                <div id="pieChart2"></div>
                                <script>
                                    document.addEventListener("DOMContentLoaded", () => {
                                        new ApexCharts(document.querySelector("#pieChart2"), {
                                            series: [
                                                <?php echo $nbrPersonneltotal; ?>,
                                                <?php echo $nbrPersonnelactif; ?>,
                                            ],
                                            chart: {
                                                height: 350,
                                                type: 'pie',
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Utilisateur Par Profils</h5>
                    ...
                    <div class="card">
                                        <div class="card-body">
                                                <h5 class="card-title">Dix Derniers Evenements</h5>
