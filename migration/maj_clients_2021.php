...
$inputFileName = 'credits_clients_2021.xls';
...
$i=1491; // a modifier demain

$op=777; //à modifier au suivant
...
for ($row = 2; $row <= $highestRow; $row++){ 
    ...
    $datepaie = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP($ligne[0][3]));
    $datefact = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP($ligne[0][4]));  
    $projet = $ligne[0][5];
    $creance= $ligne[0][6];
