...
<?php
    ...
    $sql = "SELECT COUNT(IDContrats) as NBRES FROM Contrats  WHERE (YEAR(date_creation) = $annee  && is_delete = 1)";
    $nbr1 = $pdo->query($sql);
    $nbrcontrat = $nbr1->fetchColumn();


    $sql = "SELECT COUNT(IDContrats) as NBRES FROM Contrats  WHERE (etat_enreg = 'Oui' && YEAR(date_creation) = $annee  && is_delete = 1)";
    $nbr2 = $pdo->query($sql);
    $nbrcontratApprouve = $nbr2->fetchColumn();

    $sql = "SELECT COUNT(IDAvenant) as NBRES FROM Avenant  WHERE (YEAR(date_creation) = $annee  && is_delete = 1)";
    $nbr3 = $pdo->query($sql);
    $nbrAvenant = $nbr3->fetchColumn();
...
<html lang="fr">
    ...
    <head>
        ...
        <!-- ======= Title ======= -->
        <title>Dashboard - Contrat| SIGAMP-94</title>
        ...
        <link href="new_assets/assets_dashboard/css/header/style.css" rel="stylesheet" media="all">
         ...
         <!-- ======= Template Main CSS File Dashboard ======= -->
                <?php if ($_SESSION['droit'] != "admin" && $_SESSION['droit']!= "Ordonateur" && $_SESSION['droit']!= "courrier" && $_SESSION['droit']!= "UGAO" && $_SESSION['droit']!= "UGAC" && $_SESSION['droit']!= "UGAD" && $_SESSION['droit']!= "CSM" && $_SESSION['droit'] != "Controleur_Financier") {
...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
        ...
        <main id="main" class="main">
            ...
            <div class="card recent-sales">
                <h1 class="card-title text-center fw-bold"> DASHBOARD CONTRAT: <?php echo($month . ' ' .$annee);?></h1>
                ...
                <div class="row">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card info-card sales-card">
                            <div class="card-body">
                                <h5 class="card-title">Contrat <span>| Total</span></h5>
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <h6><?php echo $nbrcontrat; ?></h6>
                                        <span class="text-success small pt-1 fw-bold"><?php echo $nbrcontrat ?></span> <span class="text-muted small pt-2 ps-1">Contrat</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card info-card sales-card">
                            <div class="card-body">
                                <h5 class="card-title">Contrat <span>| Approuvé</span></h5>
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <h6><?php echo $nbrcontratApprouve; ?></h6>
                                        <span class="text-success small pt-1 fw-bold"><?php echo $nbrcontratApprouve ?></span> <span class="text-muted small pt-2 ps-1">Contrat</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card info-card sales-card">
                            <div class="card-body">
                                <h5 class="card-title">Avenant</h5>
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <h6><?php echo $nbrAvenant; ?></h6>
                                        <span class="text-success small pt-1 fw-bold"><?php echo $nbrAvenant ?></span> <span class="text-muted small pt-2 ps-1">Avenant</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Statistique des Contrat Validés</span></h5>
