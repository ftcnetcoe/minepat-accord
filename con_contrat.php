...
$crud->displayAs(array(
		...
		'date_debut' => 'Date de Début',
                ...
                'PJ_Decision' => "Décision l'Attribution", 
 ...
 $crud->columns(['IDProjet','IDSoumiss','Objet_contrat','date_attribution','date_debut','duree','Montant','PJ_Decision']);
 $crud->editFields(['IDProjet','Objet_contrat','date_attribution','date_debut','duree','Montant','PJ_Decision']);
 $crud->addFields(['IDProjet','Objet_contrat','date_attribution','date_debut','duree','Montant','PJ_Decision']);
$crud->requiredFields(['IDProjet','Objet_contrat','date_attribution', 'date_debut','Montant']);
