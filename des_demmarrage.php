...
$crud->columns(['Doc_exigible','IDContrats','idAttribution','IDProjet','IDSoumiss','IDDmdePD','date','Montant','PJ_note_paiement','Pj_Accord_paiement']);
$crud->editFields(['IDContrats','idAttribution','IDProjet','IDSoumiss','IDDmdePD','date','Montant','PJ_note_paiement','Pj_Accord_paiement']);
$crud->addFields(['IDContrats','idAttribution','IDDmdePD','date','Montant','PJ_note_paiement','Pj_Accord_paiement']);
$crud->requiredFields(['IDContrats','idAttribution','Montant','IDDmdePD','date']);
$crud->readOnlyFields(['IDProjet','IDSoumiss']);


$crud->where([
    'descompte.is_delete = 1',
    'descompte.Type = "Avance démarrage"',
]);
