<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.7.4.ae70528.css');
    ...
    if ($autoload_javascript) {
        $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.7.4.ae70528' . $minify_or_not . '.js');
    } else {
        $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-no-autoload-v2.7.4.ae70528' . $minify_or_not . '.js');
    }
