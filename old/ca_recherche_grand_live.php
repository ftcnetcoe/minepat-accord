<?php
    ...
    $namePage = 'recherche_grand_livre';
...
<html>
    ...
    <head>
        ...
        <!-- ======= Title ======= -->
        <title>Grand livre des Compte</title>
  ...
  <!-- ======= Debut Header ======= -->
        ...
        <main id="main" class="main">
            ...
            <div class="card recent-sales">
                <h1 class="card-title text-center fw-bold">GRAND-LIVRE DES COMPTES</h1>
            </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-4 mx-auto">
                        <h3 class="text-center mt-4 mb-4 h3">Période</h3>
                         <form method="post" action ="ca_report_grand_livre.php">
                            <div class="mb-4">
