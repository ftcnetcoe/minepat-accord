...
$crud->setTable('soumissionaire'); //definition de la table
$crud->setSubject('Soumissionnaire', 'Gestion des Soumissionnaires');



//definition de l'afichage des champs de la table
$crud->displayAs(array(
	     'nom_entreprise' => "Nom du soumissionnaire",
             'domaine_expertise' => "domaine d'expertise",
	     'Commentaire' => "Commentaire sur le Soumissionnaire",

)); 

		
		
$crud->columns(['nom_entreprise', 'domaine_expertise', 'Commentaire']);
$crud->editFields(['nom_entreprise', 'domaine_expertise', 'Commentaire']);
$crud->addFields(['nom_entreprise', 'domaine_expertise', 'Commentaire']);
$crud->requiredFields(['nom_entreprise']);
...
$crud->defaultOrdering('nom_entreprise', 'ASC');
...
<head>
        ...
        <title>Soumissionaire- MINEPAT </title>
