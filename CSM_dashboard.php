...
<?php
    ...
    if (isset($_SESSION['idu'])&& ( $_SESSION['droit']== "admin" || $_SESSION['droit']== "CSM")){ // si paramètres correct.
?>
...
<?php
    ...
    $sql = "SELECT * FROM Projet WHERE (Libelle_avis = ' ' && YEAR(date_creation) = $annee)";
...
<html lang="fr">
    ...
    <head>
        ...
        <!-- ======= Title ======= -->
        <title>Dashboard - Chef Service Marchés| SIGAMP-94</title>
...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
        ...
        <main id="main" class="main">
            ...
            <div class="card recent-sales">
                <h1 class="card-title text-center fw-bold"> DASHBOARD Chef Service Marchés : <?php echo($month . ' ' .$annee);?></h1>
            ...
            <div class="modal fade" id="basicModal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="CSM_dashboard.php" method="GET">
