...
<?php
    ...
    if (isset($_SESSION['idu'])&& ( $_SESSION['droit']== "admin" || $_SESSION['droit']== "courrier")){ // si paramètres correct.
?>
...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
        ...
        <main id="main" class="main">
            ...
            <div class="card recent-sales">
                <h1 class="card-title text-center fw-bold"> DASHBOARD Courrier : <?php echo($month . ' ' .$annee);?></h1>
            ...
            <div class="modal fade" id="basicModal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="courrier_dashboard.php" method="GET">
