...
$crud->displayAs(array(
		...
		'date_debut' => 'Date de Début',
                ...
                'date_visa' => "Date Apposition du Visa", 
                'marche_souscrit' => "Marché Souscrit", 
 ...
 $crud->columns(['IDProjet','IDSoumiss','Objet_contrat','date_visa','marche_souscrit','PJ_VisaBudg']);
 $crud->editFields(['IDProjet','IDSoumiss','Objet_contrat','date_visa','marche_souscrit','PJ_VisaBudg']);
 $crud->addFields(['IDProjet','IDSoumiss','Objet_contrat','date_visa','marche_souscrit','PJ_VisaBudg']);
$crud->requiredFields(['date_visa','PJ_VisaBudg']);
...
if ($_SESSION['droit']!= "admin"  && $_SESSION['droit'] != "Controleur_Financier"){
